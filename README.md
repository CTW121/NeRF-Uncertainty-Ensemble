...
## How to train NeRF Uncertainty Ensemble model
...
The uncertainty estimated by the NeRF Uncertainty Ensemble model can be visualized using uncertainty visualization tool [NeRFDeltaView Ensemble](https://github.com/CTW121/NeRFDeltaView-Ensemble).
